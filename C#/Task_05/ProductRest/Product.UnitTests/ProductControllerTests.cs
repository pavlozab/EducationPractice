...
namespace Product.UnitTests
{
    public class ProductControllerTests // FIXME  
    {
        ...
        public async Task UpdateProductAsync_WithProductToUpdate_ReturnsNoContent() 
        {
            ...
            var productToUpdate = TestUpdateProductDto();
        ...
        public async Task UpdateProductAsync_WithUnexistingProduct_ReturnsNotFound() 
        {
            ...
            var productToUpdate = TestUpdateProductDto();
            //
            // _productService.Setup(serv => serv.UpdateProduct(It.IsAny<Guid>(),
        ...
        // {
        //     // Arrange 
        //     var expectedProducts = new List<Product>() {TestProductDto(), TestProductDto(), TestProductDto()};
        //     var filter = new QueryParametersModel();
        //     
        //     _productService.Setup(serv => serv.GetProducts(It.IsAny<QueryParametersModel>()))
        ...
        private UpdateProductDto TestUpdateProductDto() 
        {
            return new()
            {
                AddressLine = "new address",
